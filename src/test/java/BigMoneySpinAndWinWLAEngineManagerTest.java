...
public class BigMoneySpinAndWinWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(BigMoneySpinAndWinWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/BigMoneySpinAndWinWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/BigMoneySpinAndWinWLAIW/InitOutcome.xml").getDocumentElement();
